...
public class ParryAttributes {
    public static final Codec<ParryAttributes> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codec.INT.fieldOf("parryTicks").forGetter(ParryAttributes::getParryTicks),
            Codec.FLOAT.fieldOf("meleeDamageTakenAfterBlock").forGetter(ParryAttributes::getMeleeDamageTakenAfterBlock),
            Codec.FLOAT.fieldOf("projectileDamageTakenAfterBlock").forGetter(ParryAttributes::getProjectileDamageTakenAfterBlock),
            Codec.FLOAT.fieldOf("explosionDamageTakenAfterBlock").forGetter(ParryAttributes::getExplosionDamageTakenAfterBlock),
            Codec.FLOAT.fieldOf("cooldownAfterParryAction").forGetter(ParryAttributes::getCooldownAfterParryAction),
            Codec.FLOAT.fieldOf("cooldownAfterInterruptingBlockAction").forGetter(ParryAttributes::getCooldownAfterInterruptingBlockAction),
            Codec.FLOAT.fieldOf("cooldownAfterAttack").forGetter(ParryAttributes::getCooldownAfterAttack),
            Codec.INT.optionalFieldOf("maxUseTime", 7200).forGetter(ParryAttributes::getMaxUseTimeParry),
            Codec.INT.optionalFieldOf("blockDelay", 0).forGetter(ParryAttributes::getBlockDelay),
            Codec.INT.optionalFieldOf("explosionBlockDelay", -1).forGetter(ParryAttributes::getExplosionBlockDelay),
            Codec.BOOL.optionalFieldOf("shouldStopUsingItemAfterBlockOrParry", true).forGetter(ParryAttributes::shouldStopUsingItemAfterBlockOrParry),
            Codec.DOUBLE.optionalFieldOf("knockbackAfterParryAction", 4.0).forGetter(ParryAttributes::getKnockbackAfterParryAction),
            ParryEffect.CODEC.listOf().optionalFieldOf("parryEffects", List.of()).forGetter(ParryAttributes::getParryEffectsList)
    ).apply(instance, ParryAttributes::new));
    ...
    private ParryAttributes(int parryTicks, float meleeDamageTakenAfterBlock, float projectileDamageTakenAfterBlock,
                            float explosionDamageTakenAfterBlock, float cooldownAfterParryAction,
                            float cooldownAfterInterruptingBlockAction, float cooldownAfterAttack,
                            int maxUseTime, int blockDelay, int explosionBlockDelay,
                            boolean shouldStopUsingItemAfterBlockOrParry, double knockbackAfterParryAction,
                            List<ParryEffect> parryEffectsList) {
        ...
        for (ParryEffect effect : parryEffectsList) {
            this.parryEffects.put(effect.statusEffect(),
                    new Quartet<>(effect.duration(), effect.amplifier(), effect.chance(), effect.enchantmentMultiplier()));
        }
    }
