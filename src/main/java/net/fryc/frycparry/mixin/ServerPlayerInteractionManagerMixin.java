...
abstract class ServerPlayerInteractionManagerMixin implements ServerParryInteraction {
    ...
    @Override
    public ActionResult frycparry_interactItemParry(ServerPlayerEntity player, World world, ItemStack stack, Hand hand) {
        if (this.gameMode == GameMode.SPECTATOR) {
            ...
            if (ParryHelper.isItemParryEnabled(stack)) {
                typedActionResult = ((ParryItem) stack.getItem()).frycparry_useParry(world, player, hand);
            } else {
